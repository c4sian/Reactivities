    ...
    return (
        <Card elevation={3} sx={{ borderRadius: 3 }}>
            <Box display='flex' alignItems='center' justifyContent='space-between'>
                <CardHeader
                    avatar={<Avatar
                        src={activity.hostImageUrl} alt="Image of host"
            ...
            <CardContent sx={{ padding: 0 }}>
                <Box display='flex' alignItems='center' marginBottom={2} px={2}>
                ...
                <Divider />
                <Box display='flex' gap={2} sx={{ backgroundColor: 'grey.200', py: 3, paddingLeft: 3 }}>
